...
<%
	...
	String idconto = request.getParameter("id");
...
%>
		<FORM name="selezione" action="bilancio" method="get" onSubmit="return isOk()">
			<TABLE class="tcontent" align="center" style="width:25% ">
				<TR>
					<TD>
						<input type="radio" name="what" value="tutte" onClick="javascript:dis();">
					</TD>
					<TD colspan="3">
						Tutte
					</TD>
				...
				<TR>
					<TD>
						<input type="radio" name="what" value="anno" onClick="javascript:dis();" checked>
					</TD>
					<TD>Anno</TD>
					<TD colspan="2">
						<input type="text" name="anno" style="width:50px; height:18px; font-size:9px; vertical-align:bottom" maxlength="4" value="<%= anno %>">
					</TD>
				</TR>
				<TR>
					<TD>
				...
				<TR>
					<TD colspan="2" align="left">
						<BR><input type="button" value="Indietro" onClick="window.location.href='javascript:history.back();'">
					</TD>
			...
			<input type="hidden" name="action" value="scheda">
			<input type="hidden" name="id" value="<%= idconto %>">
