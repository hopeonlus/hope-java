...
public class MainCtrl extends HttpServlet {
	...
	private void insertUser(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (q.list().size() > 0) {
				throw new Exception("Username <B>" + username + "</B> gi� usato!");
			}
	...
	private void pageUsers(HttpServletRequest request, HttpServletResponse response) {
		...
		// SendMail.sendMail("smtp.libero.it", "zanitete@gmail.com",
		// "prova da java!", "messaggio di prova da javA!tiscali!",
		// "c://01.jpg", "zanitete@libero.it", "zanitete@libero.it" );
	}
