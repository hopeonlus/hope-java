...
function openWindow() {
	popupWin = window.open('http://www.hopeonlus.it/dove_siamo.html', 'remote', 'width=600,height=400,toolbar=no,scrollbars=no,resizable=no,menubar=no')
}
...
<BODY onLoad="preloadImages();" background="img/back_blu.jpg">
	<div id="container">
		...
		<div id="menunew">
     		 <ul> 
				<li><a href="home?action=SHOW&what=CHISIAMO" id="sel">CHi SiAMO</a></li> 
		...
		<div id="testo">
			...
			<div style="padding-top:3px; color:#000099; padding-left:10px">
			...
			<table align="center">
				<TR>
					<TD align="right" valign="top"><h4><B>SEDE </B></h4></TD>
					...
					<h3>
						...
						Italia<BR/>
						Tel. 0331/960272<BR/>
						E-mail : <script language="javascript">printInd('info');</script><br/><br/>
						<a href="#" onClick="javascript:openWindow()">MAPPA <img src="img/zoom.png" border="1" height="16" title="Map" alt=""></a>
					</h3>
					</TD>
				</TR>
				<TR><TD><BR></TD></TR>
				<TR>
					<TD align="right" valign="top"><h4><B>WEBMASTER </B></h4></TD>
					<TD align="left" style="padding-left:30px ">
						<h3>
						E-mail : <script language="javascript">printInd('webmaster');</script>
						</h3>
					</TD>
				</TR>
			</table>
