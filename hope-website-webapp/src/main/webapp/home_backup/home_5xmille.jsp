	...
	<div id="container">
		...
		<div id="testo">
			...
			<TABLE cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" align="center">
				...
				<TR>
					<TD><img src="img/cornice/tileSx_dx.gif" width="20" height="210"></TD>
					<TD>
						<table width="100%">
							<TR>
								<TD align="center" valign="top" colspan="2" tyle="border-top:1px dashed #999999; border-left:1px dashed #999999; border-right:1px dashed #999999;">
									<font  class="progetto_large" face="Courier New, Courier, mono" style="font-style:normal; ">
										<B>iN PRiMO PiANO</B>
									</font>
								</TD>
							</TR>
							<TR height="170px">
								<TD align="justify" colspan="2" valign="top" tyle="padding-top:1px; border-bottom:1px dashed #999999; border-left:1px dashed #999999; border-right:1px dashed #999999;">
									<table align="right" style="padding:5px ">
										<tr>
											<td>
												<a href="home?action=VIEW&what=cinquexmille"><img src="img/5x1000x220.jpg" align="left" border="0"></a>
											</td>
										</tr>
									</table>
									<font class="testo"><BR>La "Finanziaria" 2006 introduce la possibilità di <B>donare il 5 per mille</B> della propria imposta sul reddito ad <B>associazioni di volontariato</B>.<BR>
										Per quest'anno è possibile quindi aiutare la <strong>H.O.P.E.</strong> anche in questo modo inserendo dove richiesto, nel modello 730 o nel modello Unico, il nostro <BR><BR><div align="center"><B>CODICE FISCALE : 92013500126</div></B><br>
										<BR>
										<div align="center"><a href="home?action=SHOW&what=cinquexmille" style="color:#FF0000; text-decoration:underline ">maggiori informazioni >></a></div>
									</font>
								</TD>
							</TR>
						</table>
					</TD>
					<TD><img src="img/cornice/tileDx_dx.gif" width="24" height="210"></TD>
				</TR>
				<TR>
					<TD><img src="img/cornice/AngSxDown_dx.gif"></TD>
			...
			<TABLE width="85%">
				<TR><TD></TD></TR>
				<TR>
					<td valign="bottom" style="padding-top:4px; border-top:1px dashed #999999; border-left:1px dashed #999999; border-bottom:1px dashed #999999;">
						<a href="news"><img src="img/news_blu.jpg" align="center" border="0"></a>
					</td>
					<TD valign="bottom"style="padding-top:4px; border-top:1px dashed #999999; border-right:1px dashed #999999; border-bottom:1px dashed #999999;">
						<a href="adozioni"><img src="img/adotta_blu.jpg" align="right" border="0"></a>
					</td>
				</tr>
			</table>
		</div>
