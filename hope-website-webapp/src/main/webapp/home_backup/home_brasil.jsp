						...
						<table width="100%">
							<TR>
								<TD align="center" valign="top" colspan="2">
									<font  class="progetto_large" face="Courier New, Courier, mono" style="font-style:normal;font-weight: normal;color:#006600 ">
										iN PRiMO PiANO: <b>"Istruzione, Formazione, Autocoscienza: il riscatto di una comunit&aacute;"</B>
									</font>
								</TD>
							</TR>
							<TR>
								<TD colspan="2" valign="top" >
									<table align="left" style="padding:5px ">
										<tr>
											<td>
												...
												<a href="./download/brasile/loc_brasile_img_2.jpg">
													<img src="./download/brasile/loc_brasile_img_2.jpg" align="left" border="0" height="180px">
												</a>
											</td>
										</tr>
									</table>
									<div align="center">
										...
										<font  class="progetto_large" face="Courier New, Courier, mono" style="font-style:normal;font-weight: normal; ">
											<b>Venerdi' 1 Giugno</b>
										</font>
										<br>
										<br>
										<font class="testo"><b>Oratorio di Angera</b>
										<br>
										Vi aspettiamo...
										...
										<br><br>
										<a href="./download/brasile/loc_brasile_img_2.jpg" style="font-size:14px">:: locandina ::</a>
										</font>
								  </div>
								</TD>
							</TR>
