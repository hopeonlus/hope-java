...
<BODY background="img/back_blu.jpg">
	<div id="container">
		...
		<div id="testo">
			<table style="vertical-align:bottom; padding-top:12px; padding-left:10px; " width="100%" cellpadding="0" ellspacing="8px">
				<tr>
			...
			<TABLE cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" align="center">
				...
				<TR>
					<TD><img src="img/cornice/tileSx_dx.gif" width="20" height="170"></TD>
					<TD>
						<table width="100%">
							<TR>
								<TD align="center" valign="top" colspan="2" tyle="border-top:1px dashed #999999; border-left:1px dashed #999999; border-right:1px dashed #999999;">
									<font  class="progetto_large" face="Courier New, Courier, mono" style="font-style:normal;font-weight: normal; ">
										iN PRiMO PiANO: <b>MERCATiNO Di NATALE!</B>
									</font>
								</TD>
							</TR>
							<TR>
								<TD align="justify" colspan="2" valign="top" tyle="padding-top:1px; border-bottom:1px dashed #999999; border-left:1px dashed #999999; border-right:1px dashed #999999;">
									<table align="right" style="padding:5px ">
										<tr>
											<td>
												<img src="/img/news/natale2006/natale1.jpg" align="left" border="0" height="100px">
											</td>
										</tr>
									</table>
									<font class="testo"><BR>
										2 e 3 dicembre 2006, ANGERA (sala consiliare)<br>
										Prodotti artigianali e alimentari del <br><a href="javascript:window.open('http://www.altromercato.it')"><b>COMMERCiO EQUO E SOLiDALE</b></a>
										<br>
										<br>
										<div align="center">
											<a href="/download/natale2006/natale2006.pdf" align="center">::scarica locandina::</a><br><br>
											<a href="news?action=SHOW&what=NEWS&id=14" align="center">::maggiori informazioni::</a>
										</div>
								</TD>
							</TR>
						</table>
					</TD>
					<TD><img src="img/cornice/tileDx_dx.gif" width="24" height="170"></TD>
				</TR>
				<TR>
					<TD><img src="img/cornice/AngSxDown_dx.gif"></TD>
			...
			<TABLE cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" align="left">
				...
				<TR>
					<TD><img src="img/cornice/tileSx_dx.gif" width="20" height="115"></TD>
					<TD>
						<table width="100%" align="center">
							<TR>
								<TD valign="bottom">
									<font class="calend_t">
										<b>Castagnata 5 Novembre!</b><br>
									</font>
									<a href="news?action=SHOW&what=NEWS&id=13"><img src="img/news/castagnata2006/castagne.jpg" align="left" border="0" width="100px"></a>
								</td>
							</tr>
						</table>
					</TD>
					<TD><img src="img/cornice/tileDx_dx.gif" width="24" height="115"></TD>
				</TR>
				<TR>
					<TD><img src="img/cornice/AngSxDown_dx.gif"></TD>
			...
			<TABLE cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" align="right">
				<TR>
					<TD><IMG src="img/cornice/AngSxUp_dx.gif" border="0"></TD>
					<TD><img src="img/cornice/TileUp_dx.gif" width="220" height="16" border="0"></TD>
					<TD><img src="img/cornice/AngDxUp_dx.gif" border="0"></TD>
				</TR>
				<TR>
					<TD><img src="img/cornice/tileSx_dx.gif" width="20" height="100"></TD>
					<TD>
						<table width="180px" align="center">
							<TR>
								<TD valign="bottom"style="padding-top:4px; border:1px dashed #999999;">
									<a href="home?action=SHOW&what=cinquexmille"><img src="img/5x1000x220.jpg" align="left" border="0"></a>
								</td>
							</tr>
						</table>
					</TD>
					<TD><img src="img/cornice/tileDx_dx.gif" width="24" height="100"></TD>
				</TR>
				<TR>
					<TD><img src="img/cornice/AngSxDown_dx.gif"></TD>
					<TD><img src="img/cornice/tileDown_dx.gif" width="220" height="16"></TD>
					<TD><img src="img/cornice/AngDxDown_dx.gif"></TD>
				</TR>
			</TABLE>
		</div>
