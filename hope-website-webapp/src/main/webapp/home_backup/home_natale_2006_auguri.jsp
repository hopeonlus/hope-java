	...
	<div id="container">
		...
		<div id="testo">
			...
			<TABLE cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" align="center">
				<TR>
					<TD><IMG src="img/cornice/AngSxUp_dx.gif" border="0"></TD>
					<TD><img src="img/cornice/TileUp_dx.gif" width="400" height="16" border="0"></TD>
					<TD><img src="img/cornice/AngDxUp_dx.gif" border="0"></TD>
				</TR>
				<TR>
					<TD><img src="img/cornice/tileSx_dx.gif" width="20" height="60"></TD>
					<TD>
						<img src="./img/holidaytext.gif" width="380px" />
						<br>
						<img src="./img/holidaytext2.gif" width="380px" />
					</TD>
					<TD><img src="img/cornice/tileDx_dx.gif" width="24" height="60"></TD>
				</TR>
				<TR>
					<TD><img src="img/cornice/AngSxDown_dx.gif"></TD>
					<TD><img src="img/cornice/tileDown_dx.gif" width="400" height="16"></TD>
					<TD><img src="img/cornice/AngDxDown_dx.gif"></TD>
				</TR>
			</TABLE>
			<TABLE cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" align="center">
							...
							<TR>
								<TD align="center" valign="top" colspan="2" tyle="border-top:1px dashed #999999; border-left:1px dashed #999999; border-right:1px dashed #999999;">
									<font  class="progetto_large" face="Courier New, Courier, mono" style="font-style:normal;font-weight: normal; ">
										iN PRiMO PiANO: <b>MERCATiNO Di NATALE!</B>									</font>								</TD>
							</TR>
							<TR>
								<TD align="justify" colspan="2" valign="top" tyle="padding-top:1px; border-bottom:1px dashed #999999; border-left:1px dashed #999999; border-right:1px dashed #999999;">
									<table align="right" style="padding:5px ">
										<tr>
											<td><font  class="progetto_large" face="Courier New, Courier, mono" style="font-style:normal;font-weight: normal; ">
												<a href="news?action=SHOW&what=NEWS&id=15&x=PHOTOGALLERY" align="center" class="progetto_large" style="color:red">::ON-LiNE le iMMAGiNi della vendita::</a><br>
											</font>
											</td>
										</tr>
									</table>
