		...
		<div id="testo">
			...
			<% if(isok == null) {	%>
					<table width="100%" align="center" style="padding-top:14px ">
						...
						<tr>
							<td><p class="subtitle_news" align="center"><BR>...per esser sempre aggiornato su Novità ed Iniziative dell'associazione!</p></td>
						</tr>
						<tr height="15px"></tr>
						<tr>
							<td align="center">
			...
			<% } else { 
					if (isok.equals("1")) { %>
						<table width="100%" align="center" style="padding-top:14px ">
							...
							<tr>
								<td><p class="subtitle_news" align="center"><BR>Sarai in questo modo tenuto aggiornato su Novità ed Iniziative dell'associazione!</p></td>
							</tr>
							<tr>
								<td><p align="center" class="subtitle_news"><a href="home"><BR>< TORNA ALLA HOME PAGE ></a></p></td>
							</tr>
					...
					<% } else { %>
						<table width="100%" align="center" style="padding-top:14px ">
							...
							<tr>
								<td><p class="subtitle_news" align="center"><font color="#FF0000"><BR>L'e-mail <b><%= email %></b> probabilmente appartiene già alla mailing-list.</font></p></td>
							</tr>
							<tr>
