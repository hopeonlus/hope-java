	...
	<div id="container">
		...
		<div id="content">
			...
			<TABLE cellpadding="0" cellspacing="0" border="0"  bgcolor="#FFFFFF">
				<TR>
					<TD><IMG src="img/cornice/AngSxUp.gif" border="0"></TD>
					<TD><img src="img/cornice/TileUp.gif" width="120" height="16" border="0"></TD>
					<TD><img src="img/cornice/AngDxUp.gif" border="0"></TD>
				</TR>
				<TR>
					<TD><img src="img/cornice/tileSx.gif" width="20" height="120"></TD>
					<TD></TD>
					<TD><img src="img/cornice/tileDx.gif" width="24" height="120"></TD>
				</TR>
				<TR>
					<TD><img src="img/cornice/AngSxDown.gif"></TD>
					<TD><img src="img/cornice/tileDown.gif" width="120" height="16"></TD>
					<TD><img src="img/cornice/AngDxDown.gif"></TD>
				</TR>
			</TABLE>
			...
			<TABLE cellpadding="0" cellspacing="0" border="0"  bgcolor="#FFFFFF">
				...
				<TR>
					<TD><img src="img/cornice/tileSx.gif" width="20" height="55"></TD>
					<TD></TD>
					<TD><img src="img/cornice/tileDx.gif" width="24" height="55"></TD>
				</TR>
				<TR>
					<TD><img src="img/cornice/AngSxDown.gif"></TD>
					<TD><img src="img/cornice/tileDown.gif" width="120" height="16"></TD>
		...
		<div id="testo">
			<div style="padding-top:3px; color:#000099;">
				...
				<!--Inserire qui nome pagina -->nome pagina
				
				<!------------------------------------------------------->
				<!---------Inserire qui contenuto della pagina! --------->
				<!------------------------------------------------------->
