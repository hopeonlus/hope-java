...
function isOk()
{
	var a = document.socio.annop.value;
	var i = document.socio.importo.value;
	
	if((isNaN(a))|(a == ''))
	{
		alert("Campo ANNO non inserito correttamente!");
		return false;
	}
	else if((isNaN(i))|(i == ''))
	{
		alert("Campo IMPORTO non inserito correttamente!");
		return false;
	}
...
%>
		<FORM name="socio" action="soci" method="get" onSubmit="return isOk()">
					...
					<TD colspan="2">
						<TABLE class="tcontent" align="center" style="width:50% ">
							<TR>
								<TD><B>Anno : </B></TD>
								<TD>
									<input type="text" name="annop" style="width:70px " maxlength="4">
								</TD>
							</TR>
							<TR>
								<TD><B>Importo : </B></TD>
							...
							<TR>
								<TD align="left">
									<input type="button" value="Annulla" style="font-size:9px " onClick="javascript:history.back()">
								</TD>
								<TD align="right">
									<input type="submit" value="Inserisci" style="font-size:9px ">
								</TD>
							</TR>
						</TABLE>
					</TD>
				...
				<TR>
					<TD colspan="2">
						...
						<TABLE align="center" width="100%">
							<TR>
								<TD align="left">
									<INPUT type="button" value="Indietro" onClick="window.location.href='soci?action=select&what=<%= what %>&anno=<%= anno %>&dal=<%= dal %>&al=<%= al %>'" disabled>
								</TD>
								<td align="center">
									<INPUT type="button" value="Cancella" onClick="javascript:sicuro()" disabled>
								</td>
								<td align="right">
			...
			<input type="hidden" name="tessera" value="<%= tessera %>">
