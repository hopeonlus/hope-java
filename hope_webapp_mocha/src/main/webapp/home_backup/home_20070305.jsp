							...
							<TR>
								<TD align="center" valign="top" colspan="2">
									<font  class="progetto_large" face="Courier New, Courier, mono" style="font-style:normal;font-weight: normal; ">
										iN PRiMO PiANO: <b>ASSEMBLEA SOCI 2006/2007</B>
									</font>
								</TD>
							</TR>
							<TR>
								<TD colspan="2" valign="top" >
									...
									<font class="testo"><BR>
										Il giorno Domenica 18 Marzo 2007 e' prevista l'Assemblea dei soci dell'associazione. Forniremo al piu' presto maggiori informazioni quali Luogo ed Ora.<br> <div align="center">A presto...
										<br><br>
										<a href="news?action=SHOW&what=NEWS&id=16">:: news ::</a>
										</div>
								</TD>
							</TR>
						</table>
					...
					<TD>
						<table width="100%">
							<TR>
								<TD align="center" valign="top" colspan="2">
									<font  class="progetto_large" face="Courier New, Courier, mono" style="font-style:normal;font-weight: normal; ">
										<b>MERCATiNO Di NATALE!</B>									</font>								</TD>
							</TR>
							<TR>
								<TD colspan="2" valign="top">
									<table align="right" style="padding:5px ">
