	...
	<div id="container">
		...
		<div id="testo">
				...
				<TR>
					...
					<TD>
						...
						<table width="100%">
							<TR>
								<TD align="left">
								<h4>10 Febbraio 2008</h4>
								<h3>
								L'Assemblea Generale Ordinaria dei Soci della H.O.P.E. e' convoncata per il giorno
								<br/><br/>
								<div align="center"><b>Sabato 5 Aprile 2008 alle ore 16:00</b></div>
								<br/>
								presso il Centro Anziani ad Angera (piazza Parrocchiale)
								<br/><br/>
								<div align="center"><a href="news?action=SHOW&what=NEWS&id=24">maggiori informazioni</a></div>
								</h3>
								</TD>
							</TR>
						</table>					
			...
			<TABLE cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" align="left">
				<TR>
					<TD><IMG src="img/cornice/AngSxUp_dx.gif" border="0"></TD>
					<TD><img src="img/cornice/TileUp_dx.gif" width="180" height="16" border="0"></TD>
					<TD><img src="img/cornice/AngDxUp_dx.gif" border="0"></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD><img src="img/cornice/AngSxDown_dx.gif"></TD>
					<TD><img src="img/cornice/tileDown_dx.gif" width="180" height="16"></TD>
					<TD><img src="img/cornice/AngDxDown_dx.gif"></TD>
				</TR>
			</TABLE>
			<TABLE cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" align="center">
