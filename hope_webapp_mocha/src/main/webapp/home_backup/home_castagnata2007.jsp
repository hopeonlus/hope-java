...
<!--
<body onLoad="javascript:window.open('http://www.hopeonlus.it/img/loc_pecchio_mini.jpg', 'remote', 'width=340,height=500,toolbar=no,scrollbars=no,resizable=no,menubar=no')" background="img/back_blu.jpg">
-->
<BODY background="img/back_blu.jpg">
	<div id="container">
		...
		<div id="testo">
					...
					<TD>
						<table width="100%">
							<TR>
								...
								<a href="news?action=SHOW&what=NEWS&id=22">
									<font  class="progetto_large" face="Courier New, Courier, mono" style="font-style:normal;font-weight: normal;color:#990000 ">
										<b>"Castagnata della solidarieta'"</B>
									</font>
								</a>
								</TD>
							</TR>
								...
								<TD colspan="2" valign="top" >
									<div align="center">
										<font  class="progetto_large" face="Courier New, Courier, mono" style="font-style:normal;font-weight: normal; ">
											<b>Domenica 11 Novembre</b>
										</font>
										<br/><br/>
										<font class="testo"><b>Piazza Garibaldi, Angera</b>
										<br/><br/>
										Vi aspettiamo...
										<br/>
										<a href="news?action=SHOW&what=NEWS&id=22" style="font-size:14px">:: news ::</a>
										<!--a href="./img/loc_pecchio_mini.jpg" style="font-size:14px">:: locandina ::</a-->
										</font>
								  </div>
								</TD>
							</TR>
			...
			<TABLE cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" align="center">
				...
				<TR>
					<TD><img src="img/cornice/tileSx_dx.gif" width="20" height="152"></TD>
					<TD>
						<table width="100%">
							<tr>
								<td rowspan="2">
									<a href="news?action=SHOW&what=NEWS&id=23">
										<img alt="" src="./img/news/trovieri/locandina_trovieri_1.jpg" height="130" border="0"/>
									</a>
								</td>
								<TD align="center" valign="top" colspan="2">
									<a href="news?action=SHOW&what=NEWS&id=23">
									<font  class="subtitle_news" face="Courier New, Courier, mono" style="font-style:normal;font-weight: normal;color:#990000 ">	
										<b>"Africa per noi...noi per l'Africa"</B><br/>
										Concerto eseguito da "I Trovieri del Lago Maggiore"<br/>
									</font>
									</a>
								</TD>
							</TR>
							<TR>
								<TD colspan="2" valign="top" >
									<div align="center">
										<br>
										<font  class="subtitle_news" face="Courier New, Courier, mono" style="font-style:normal;font-weight: normal;color:red ">
											<b>Sabato 24 Novembre ore 21:00</b>
										</font>
										<br/>
										<font class="testo"><b>Sala Consilare, Angera</b>
										<br/><br/>
										<a href="news?action=SHOW&what=NEWS&id=23" style="font-size:12px">:: maggiori informazioni ::</a>
										<br/>
										<a href="./download/trovieri/programma_trovieri.pdf" style="font-size:12px">:: programma ::</a>
										</font>
								  </div>
								</TD>
							</TR>
					...
					<TD><img src="img/cornice/tileDx_dx.gif" width="24" height="152"></TD>
				</TR>
				<TR>
					<TD><img src="img/cornice/AngSxDown_dx.gif"></TD>
					<TD><img src="img/cornice/tileDown_dx.gif" width="388" height="16"></TD>
	...
	<map name="mainIMG_map">
		<area shape="rect" alt="" coords="24,8,104,125">
</map>
