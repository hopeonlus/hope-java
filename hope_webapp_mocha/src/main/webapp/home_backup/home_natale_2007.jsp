	...
	<div id="container">
		...
		<div id="menu_dx">
			<TABLE cellpadding="0" cellspacing="0" border="0">
				...
				<TR>
					<TD colspan="3" style="padding-left:18px; padding-top:115px">
					<br/>
						...
						<table width="100%">
							<TR>
								...
								<font  class="progetto_large" face="Courier New, Courier, mono" style="font-style:normal;font-weight: normal; ">
										La <b>H.O.P.E ONLUS</b> augura a tutti voi Soci, simpatizzanti o semplici visitatori<br>un <b>Buon Natale ed un Felice inizio 2008!</b>
								</font><br/><br/>
								<font class="progetto">
									Tornate a visitarci presto per esser aggiornati sulle nuove iniziative dell'associazione!<br/>
								</font>
								</TD>
							</TR>
						</table>					
