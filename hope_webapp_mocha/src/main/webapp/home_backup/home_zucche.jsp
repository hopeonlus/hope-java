							...
							<TR>
								<TD align="center" valign="top" colspan="2" tyle="border-top:1px dashed #999999; border-left:1px dashed #999999; border-right:1px dashed #999999;">
									<font  class="progetto_large" face="Courier New, Courier, mono" style="font-style:normal;font-weight: normal; ">
										iN PRiMO PiANO: <b>ZUCCAMANiA 2006!!!</B>
									</font>
								</TD>
							</TR>
							<TR>
								<TD align="justify" colspan="2" valign="top" tyle="padding-top:1px; border-bottom:1px dashed #999999; border-left:1px dashed #999999; border-right:1px dashed #999999;">
									<table align="right" style="padding:5px ">
										<tr>
											<td>
												<img src="img/news/zucche1.jpg" align="left" border="0" width="120px">
											</td>
										</tr>
									</table>
									<font class="testo"><BR>
										<BR>
										<b>Domenica 15 Ottobre</B> appuntamento sul lungolago di <b>Angera</b> per la consueta FESTA DELLA ZUCCA!
									</font>
								</TD>
							</TR>
							<tr>
								<td>
									<div align="center" class="testo"><a href="/news?action=SHOW&what=NEWS&id=7" style="color:#FF0000; text-decoration:underline ">maggiori informazioni >></a></div>
								</td>
							</tr>
						</table>
					</TD>
						...
						<table width="60%" align="center">
							<TR>
								<TD valign="bottom"style="padding-top:4px;">
									<a href="news?action=SHOW&what=NEWS&id=8"><img src="img/news/chitarra.jpg" align="left" border="0" width="70px"></a>
								</td>
							</tr>
						</table>
					</TD>
