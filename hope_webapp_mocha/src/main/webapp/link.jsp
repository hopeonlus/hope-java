...
<TITLE>H.O.P.E. ONLUS - Links</TITLE>
<STYLE type="text/css">
	...
	<div id="container">
		...
		<div id="testo">
			...
			<table align="center" style="padding-top:10px;">
				<TR>
					<TD align="right" valign="top"><h4><B>Associazioni Locali</B></h4></TD>
					<TD align="left" style="padding-left:30px; line-height:20px; ">
						<h3>
							<a href="#" onClick="window.open('http://www.gido.it');">GIDO Massimiliano Mobiglia ONLUS</a><br/>
							<a href="#" onClick="window.open('http://www.volontariprotezionecivileangera.it');">Protezione Civile</a><br/>
							<a href="#" onClick="window.open('http://www.cva-angera.it');">C.V.A. - Corpo Volontari Ambulanza</a><br/>
							<a href="#" onClick="window.open('http://www.lostessocielo.it');">Cooperativa Lo Stesso Cielo ONLUS</a><br/>
							<a href="#" onClick="window.open('http://www.cesvov.it');">CESVOV - Varese</a></b><br/>
						</h3>
					</TD>
				</TR>
				<TR>
					<TD align="right" valign="top"><h4><B>Altre Associazioni</B></h4></TD>
					<TD align="left" style="padding-left:30px; line-height:20px; ">
						<h3>
							<a href="#" onClick="window.open('http://www.calcuttaproject.org');">Progetto Calcutta</a><br/>
							<a href="#" onClick="window.open('http://www.emergency.it');">Emergency</a><br/>
							<a href="#" onClick="window.open('http://www.pime.org');">P.I.M.E.</a><br/>
							<a href="#" onClick="window.open('http://www.acli.it');">A.C.L.I.</a><br/>
						</h3>
					</TD>
				</TR>
				<TR>
					<TD align="right" valign="top"><h4><B>Altro</B></h4></TD>
					<TD align="left" class="content_news" style="padding-left:30px; line-height:20px; ">
						<h3>
							<a href="#" onClick="window.open('http://www.altromercato.it');">Altromercato</a><br/>
							<a href="#" onClick="window.open('http://www.peacereporter.it');">Peacereporter</a><br/>
						</h3>
					</TD>
				</TR>
